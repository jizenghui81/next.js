...
use turbo_binding::turbopack::core::{
    ...
    chunk::{
        availability_info::AvailabilityInfo, ChunkGroupReferenceVc, ChunkGroupVc, ChunkItem,
        ChunkItemVc, ChunkVc, ChunkableAsset, ChunkableAssetVc, ChunkingContext, ChunkingContextVc,
    },
    ident::AssetIdentVc,
    reference::AssetReferencesVc,
};
use turbo_binding::turbopack::dev::{ChunkListReferenceVc, DevChunkingContextVc};
use turbo_binding::turbopack::ecmascript::chunk::{
...
use turbo_binding::turbopack::turbopack::ecmascript::{
    chunk::EcmascriptChunkingContextVc, utils::StringifyJs,
};
    ...
    async fn content(&self) -> Result<EcmascriptChunkItemContentVc> {
            ...
            DevChunkingContextVc::resolve_from(inner.chunking_context).await?
        {
            let chunk_list_path = dev_chunking_context
                .chunk_list_path(group.entry().ident().path())
                .await?;
